...
__export(vue_runtime_esm_bundler_exports, {
  ...
  customRef: () => customRef,
  default: () => vue_runtime_esm_bundler_default,
  ...
  for (const key of Object.keys(config)) {
    if (key !== "MODE" && !(key in deprecationData) && !(key in warnedInvalidKeys)) {
      if (key.startsWith("COMPILER_")) {
        if (isRuntimeOnly()) {
          warn$1(`Deprecation config "${key}" is compiler-specific and you are running a runtime-only build of Vue. This deprecation should be configured via compiler options in your build setup instead.
Details: https://v3-migration.vuejs.org/breaking-changes/migration-build.html`);
  ...
  if (instance && config["OPTIONS_DATA_MERGE"] != null) {
    warn$1(`Deprecation config "${"OPTIONS_DATA_MERGE"}" can only be configured globally.`);
  }
}
  ...
  if (isCompatEnabled("INSTANCE_ATTRS_CLASS_STYLE", instance) && vnode.shapeFlag & 4 && root.shapeFlag & (1 | 6)) {
    ...
    if (cls || style) {
      if (inheritAttrs === false) {
        warnDeprecation("INSTANCE_ATTRS_CLASS_STYLE", instance, getComponentName(instance.type));
      }
...
function mergeDataFn(to, from) {
  ...
  return function mergedDataFn() {
    return (isCompatEnabled("OPTIONS_DATA_MERGE", null) ? deepMergeData : extend)(isFunction(to) ? to.call(this, this) : to, isFunction(from) ? from.call(this, this) : from);
  };
}
    ...
    if (hasDefault && value === void 0) {
      ...
      if (opt.type !== Function && isFunction(defaultValue)) {
        ...
        if (key in propsDefaults) {
          ...
          value = propsDefaults[key] = defaultValue.call(isCompatEnabled("PROPS_DEFAULT_THIS", instance) ? createPropsDefaultThis(instance, props, key) : null, props);
          unsetCurrentInstance();
        }
      } else {
        value = defaultValue;
...
function createCompatVue(createApp2, createSingletonApp) {
  ...
  Vue2.version = `2.6.14-compat:${"3.2.41"}`;
...
var GLOBALS_WHITE_LISTED, isGloballyWhitelisted, specialBooleanAttrs, isSpecialBooleanAttr, listDelimiterRE, propertyDelimiterRE, HTML_TAGS, SVG_TAGS, isHTMLTag, isSVGTag, toDisplayString, replacer, EMPTY_OBJ, EMPTY_ARR, NOOP, NO, onRE, isOn, isModelListener, extend, remove, hasOwnProperty, hasOwn, isArray, isMap, isSet, isDate, isFunction, isString, isSymbol, isObject, isPromise, objectToString, toTypeString, toRawType, isPlainObject, isIntegerKey, isReservedProp, isBuiltInDirective, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate, capitalize, toHandlerKey, hasChanged, invokeArrayFns, def, toNumber, _globalThis, getGlobalThis, activeEffectScope, EffectScope, createDep, wasTracked, newTracked, initDepMarkers, finalizeDepMarkers, targetMap, effectTrackDepth, trackOpBit, maxMarkerBits, activeEffect, ITERATE_KEY, MAP_KEY_ITERATE_KEY, ReactiveEffect, shouldTrack, trackStack, isNonTrackableKeys, builtInSymbols, get, shallowGet, readonlyGet, shallowReadonlyGet, arrayInstrumentations, set, shallowSet, mutableHandlers, readonlyHandlers, shallowReactiveHandlers, shallowReadonlyHandlers, toShallow, getProto, mutableInstrumentations, readonlyInstrumentations, shallowInstrumentations, shallowReadonlyInstrumentations, mutableCollectionHandlers, shallowCollectionHandlers, readonlyCollectionHandlers, shallowReadonlyCollectionHandlers, reactiveMap, shallowReactiveMap, readonlyMap, shallowReadonlyMap, toReactive, toReadonly, RefImpl, shallowUnwrapHandlers, CustomRefImpl, ObjectRefImpl, _a, ComputedRefImpl, stack, ErrorTypeStrings, isFlushing, isFlushPending, queue, flushIndex, pendingPostFlushCbs, activePostFlushCbs, postFlushIndex, resolvedPromise, currentFlushPromise, RECURSION_LIMIT, getId, comparator, isHmrUpdating, hmrDirtyComponents, map, devtools, buffer, devtoolsNotInstalled, devtoolsComponentAdded, devtoolsComponentUpdated, _devtoolsComponentRemoved, devtoolsComponentRemoved, devtoolsPerfStart, devtoolsPerfEnd, deprecationData, instanceWarned, warnCount, globalCompatConfig, seenConfigObjects, warnedInvalidKeys, eventRegistryMap, compatModelEventPrefix, warnedTypes, currentRenderingInstance, currentScopeId, withScopeId, accessedAttrs, getChildRoot, getFunctionalFallthrough, filterModelListeners, isElementRoot, isSuspense, SuspenseImpl, Suspense, hasWarned, INITIAL_WATCHER_VALUE, TransitionHookValidator, BaseTransitionImpl, BaseTransition, isAsyncWrapper, isKeepAlive, KeepAliveImpl, KeepAlive, createHook, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onServerPrefetch, onRenderTriggered, onRenderTracked, legacyDirectiveHookMap, COMPONENTS, DIRECTIVES, FILTERS, NULL_DYNAMIC_COMPONENT, skipLegacyRootLevelProps, normalizedFunctionalComponentMap, legacySlotProxyHandlers, staticCacheMap, getPublicInstance, publicPropertiesMap, isReservedPrefix, PublicInstanceProxyHandlers, RuntimeCompiledPublicInstanceProxyHandlers, shouldCacheAccess, internalOptionMergeStrats, isSimpleType, isInternalKey, normalizeSlotValue, normalizeSlot, normalizeObjectSlots, normalizeVNodeSlots, initSlots, updateSlots, isCopyingConfig, singletonApp, singletonCtor, methodsToPatch, patched, uid, hasMismatch, isSVGContainer, isComment, supported, perf, queuePostRenderEffect, isTeleport, isTeleportDisabled, isTargetSVG, resolveTarget, TeleportImpl, Teleport, normalizedAsyncComponentMap, Fragment, Text, Comment, Static, blockStack, currentBlock, isBlockTreeEnabled, vnodeArgsTransformer, createVNodeWithArgsTransform, InternalObjectKey, normalizeKey, normalizeRef, createVNode, emptyAppContext, uid$1, currentInstance, getCurrentInstance, setCurrentInstance, unsetCurrentInstance, isBuiltInTag, isInSSRComponentSetup, compile, installWithProxy, isRuntimeOnly, classifyRE, classify, computed$1, warnRuntimeUsage, ssrContextKey, useSSRContext, version, _ssrUtils, ssrUtils, resolveFilter$1, _compatUtils, compatUtils, svgNS, doc, templateContainer, nodeOps, importantRE, prefixes, prefixCache, xlinkNS, isEnumeratedAttr, optionsModifierRE, cachedNow, p, getNow, nativeOnRE, patchProp, defineSSRCustomElement, BaseClass, VueElement, TRANSITION, ANIMATION, Transition, DOMTransitionPropsValidators, TransitionPropsValidators, callHook$1, hasExplicitCallback, endId, positionMap, newPositionMap, TransitionGroupImpl, TransitionGroup, getModelAssigner, vModelText, vModelCheckbox, vModelRadio, vModelSelect, vModelDynamic, systemModifiers, modifierGuards, withModifiers, keyNames, withKeys, vShow, rendererOptions, renderer, enabledHydration, render, hydrate, createApp, createSSRApp, ssrDirectiveInitialized, initDirectivesForSSR, runtimeDom, Vue, configureCompat$1, vue_runtime_esm_bundler_default;
...
`;
  ...
  (This can also be done per-component via the "compatConfig" option.)`,
    ...
    instanceWarned = /* @__PURE__ */ Object.create(null);
    warnCount = /* @__PURE__ */ Object.create(null);
    globalCompatConfig = {
      MODE: 2
    };
    seenConfigObjects = /* @__PURE__ */ new WeakSet();
    warnedInvalidKeys = {};
    eventRegistryMap = /* @__PURE__ */ new WeakMap();
    compatModelEventPrefix = `onModelCompat:`;
    warnedTypes = /* @__PURE__ */ new WeakSet();
    ...
    skipLegacyRootLevelProps = makeMap("staticStyle,staticClass,directives,model,hook");
    normalizedFunctionalComponentMap = /* @__PURE__ */ new Map();
    legacySlotProxyHandlers = {
      get(target, key) {
        const slot = target[key];
        return slot && slot();
      }
    };
    staticCacheMap = /* @__PURE__ */ new WeakMap();
    getPublicInstance = (i) => {
      if (!i)
        return null;
    ...
    normalizedAsyncComponentMap = /* @__PURE__ */ new Map();
    ...
    Vue = createCompatVue$1();
    Vue.compile = () => {
      if (true) {
        warn$1(`Runtime compilation is not supported in this build of Vue. Configure your bundler to alias "vue" to "@vue/compat/dist/vue.esm-bundler.js".`);
      }
    };
    ({ configureCompat: configureCompat$1 } = Vue);
    vue_runtime_esm_bundler_default = Vue;
  }
});
...
export {
  ...
  initDirectivesForSSR,
  configureCompat$1,
  vue_runtime_esm_bundler_default,
  vue_runtime_esm_bundler_exports,
  init_vue_runtime_esm_bundler
};
//# sourceMappingURL=chunk-K3P4XQR7.js.map
